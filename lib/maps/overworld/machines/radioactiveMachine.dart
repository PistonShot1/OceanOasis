...
class RadioactiveMachine extends Machines
    with HasGameReference<MyGame>, CollisionCallbacks {
  RadioactiveMachine(Vector2 position) : super(position: position);

  final WasteType machineType = WasteType.radioactive;
  ...
  void _loadAllAnimations() {
    idleAnimation = SpriteAnimation.fromFrameData(
        game.images.fromCache('machines/radioactive-machine-158x148.png'),
        SpriteAnimationData.sequenced(
            amount: 1, stepTime: 0.5, textureSize: Vector2(189, 125)));
    runAnimation = SpriteAnimation.fromFrameData(
        game.images.fromCache('machines/radioactive-machine-158x148-36.png'),
        SpriteAnimationData.sequenced(
            amount: 36,
