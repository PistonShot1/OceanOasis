...
class PlasticMachine extends Machines
    with HasGameReference<MyGame>, CollisionCallbacks {
  PlasticMachine(Vector2 position) : super(position: position);

  final WasteType machineType = WasteType.plastic;
  ...
  void _loadAllAnimations() {
    idleAnimation = SpriteAnimation.fromFrameData(
        game.images.fromCache('machines/plastic-machine-272x129.png'),
        SpriteAnimationData.sequenced(
            amount: 1, stepTime: 0.5, textureSize: Vector2(272, 129)));
    runAnimation = SpriteAnimation.fromFrameData(
        game.images.fromCache('machines/plastic-machine-272x129x45.png'),
        SpriteAnimationData.sequenced(
            amount: 45,
            stepTime: animationStepTime,
            textureSize: Vector2(272, 129)));
    animations = {
